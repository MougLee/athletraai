...
import ai.athletra.athletraai.security.{ApiKey, Auth}
import ai.athletra.athletraai.util.Strings.{Id, asId}
import sttp.tapir.*
...
object UserApi extends EndpointsForDocs:
  ...
  val registerUserEndpoint = baseEndpoint.post
    ...
    .in(jsonBody[Register_IN].example(Register_IN("john", "john@athletraai.com", "1234_abcd_ABCD")))
